                        ...
                        <div className="col-xl-5 col-lg-6">
                            <div className="compus-content mb-30">
                                <div className="section-title mb-30">
                                    <h2>Students Enjoy Their
                                        Lives at<span className="down-mark-line-2">Eduman</span> Campus</h2>
                                </div>
                                <p>Helping employees gain skills and providing career development often take a back seat
                                    to business priorities but workplace better right now. Seventy percent of workers
                                    think that. </p>
                                <ul>
                                    <li><i className="far fa-check"></i>Free for physically handcraft </li>
                                    <li><i className="far fa-check"></i>Easy to enroll courses </li>
                                    <li><i className="far fa-check"></i>Access more then 100K online courses</li>
                                    <li><i className="far fa-check"></i>Upskill your organization</li>
                                </ul>
                            </div>
                        </div>
