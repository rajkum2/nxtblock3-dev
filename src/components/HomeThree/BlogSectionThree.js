                        ...
                        <div className="blog-wrapper position-relative mb-30">
                            ...
                            <div className="blog-content-wrapper">
                                ...
                                <div className="blog-content">
                                    <Link href="/blog-details"><a><h3>Ask the Expert: Typography Talk with Brian Hoff</h3></a></Link>
                                    <Link href="/blog-details"><a className="blog-btn">Read more</a></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="blog-wrapper position-relative mb-30">
                            ...
                            <div className="blog-content-wrapper">
                                ...
                                <div className="blog-content">
                                    <Link href="/blog-details"><a><h3>Stop Redesigning And Start Your Tuning Your Site Instead</h3></a></Link>
                                    <Link href="/blog-details"><a className="blog-btn">Read more</a></Link>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="blog-wrapper position-relative mb-30">
                            ...
                            <div className="blog-content-wrapper">
                                ...
                                <div className="blog-content">
                                    <Link href="/blog-details"><a><h3>How To Teach Web Design to the New Students</h3></a></Link>
                                    <Link href="/blog-details"><a className="blog-btn">Read more</a></Link>
                                </div>
                            </div>
                        </div>
